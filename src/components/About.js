...
const About = () => {
  ...
  const [state] = React.useState([
    { id: 1, title: "Name:", text: "Md Asraful Sharker Nirob" },
    { id: 2, title: "Email:", text: "asrafulsharkernirob1376@gmail.com" },
    { id: 3, title: "Phone:", text: "+880 1628560659" },
    { id: 4, title: "Linkedin", text: "Asraful_1376" },
  ]);
  return (
    <div className="about">
